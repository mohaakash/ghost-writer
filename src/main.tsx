...
import { isReactClipboardEnabled, isReactHomeEnabled, isReactHomeGeneralEnabled, isReactHomeModelsEnabled, isReactNotepadEnabled, REACT_HOME_FLAG } from "./lib/migration-flags";
...
if (isHomePage && isReactHomeEnabled()) {
  ...
  root.render(<StrictMode><HomePage fallbackToLegacy={fallbackToLegacy} modelsEnabled={isReactHomeModelsEnabled()} generalEnabled={isReactHomeGeneralEnabled()} /></StrictMode>);
